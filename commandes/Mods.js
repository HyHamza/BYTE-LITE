...
const {removeSudoNumber,addSudoNumber,issudo} = require("../byte-tables/sudo");
...
const sleep =  (ms) =>{
  ...
  Hamza({ nomCom: "tgs", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
Hamza({ nomCom: "creategroup", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
  ...
  zk.sendMessage(group.id, { text: `Group name is ${name} created by BYTE-MD-LITE` })
...
Hamza({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
Hamza({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
Hamza({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
Hamza({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
Hamza({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
Hamza({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
Hamza({
 ...
 const mbdd = require('../byte-tables/mention') ;
 ...
 if(!arg || arg.length < 1) { 
  ...
  Example: mention https://static.animecorner.me/2023/08/op2.jpg image Hi, my name is BYTE`) ; return}
...
The different types are audio, video, image, and sticker.
Example: mention https://static.animecorner.me/2023/08/op2.jpg image Hi, my name is BYTE 
